                            ...
                            <td>
                                <div class="text-center">
                                    <div class="d-flex justify-content-start">
                                        <a href="update_tram.php?id=<?php echo $fila['id_permiso']; ?>" onclick="window.open('./update/update_tram.php?id=<?php echo $fila['id_permiso']; ?>','','width=500,height=500,toolbar=NO'); return false;"><i class="btn btn-primary">Editar</i></a>
                                    </div>
                                </div>
                            </td>
                        </tr>
