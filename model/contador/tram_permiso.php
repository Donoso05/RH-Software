    ...
    <h3 class="text-center text-secondary">Tramite Permiso</h3>
        ...
        <div class="col-8 p-4">
            <table class="table">
                ...
                <tbody>
                    <?php
                    $consulta = "SELECT tram_permiso.id_permiso, usuario.id_usuario, usuario.nombre, tipo_permiso.tipo_permiso, tram_permiso.fecha_inicio, tram_permiso.fecha_fin, estado.estado, tram_permiso.id_estado
                        FROM tram_permiso
                                ...
                                <div class="text-center">
                                    <div class="d-flex justify-content-start">
                                        ...
                                        <?php } elseif ($fila["id_estado"] == 5) { ?>
                                            <button onclick="aprobarPermiso(<?php echo $fila['id_permiso']; ?>)" class="btn btn-danger ms-2">Cancelar</button>
                                        <?php } ?>
                                    </div>
                                </div>
                            </td>
