                ...
                <div class="card-body">
                    <form action="" class="form" method="post" role="form" autocomplete="off">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Id Aux. Transporte</label>
                            <div class="col-lg-9">
                                <input name="id_auxtransporte" value="<?php echo $usua['id_auxtransporte'] ?>" class="form-control" type="text" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
