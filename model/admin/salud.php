...
<body>
    ...
    <div class="container-fluid row">
        <div class="col-12 col-md-3 p-3">
            <div class="">
                <h3 class="text-center text-primary">Salud</h3>
                                ...
                                <td>
                                    <div class="text-center">
                                        <div class="d-flex justify-content-start">
                                            <a href="update_salud.php?id=<?php echo $fila['id_salud']; ?>" onclick="window.open('./update/update_salud.php?id=<?php echo $fila['id_salud']; ?>','','width=500,height=500,toolbar=NO'); return false;" class="btn btn-primary">Editar</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
