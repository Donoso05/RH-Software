                            ...
                            <td>
                                <div class="text-center">
                                    <div class="d-flex justify-content-start">
                                        <a href="update_observacion.php?id=<?php echo $fila['id_observacion']; ?>" onclick="window.open('./update/update_observacion.php?id=<?php echo $fila['id_observacion']; ?>','','width=500,height=500,toolbar=NO'); return false;" class="btn btn-primary">Editar</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
