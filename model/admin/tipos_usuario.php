                            ...
                            <td>
                                <div class="text-center">
                                    <div class="d-flex justify-content-start">
                                        <a href="update_tipo_usu.php?id=<?php echo $fila['id_tipo_usuario']; ?>" onclick="window.open('./update/update_tipo_usu.php?id=<?php echo $fila['id_tipo_usuario']; ?>','','width=500,height=500,toolbar=NO'); return false;" class="btn btn-primary">Editar</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
